...
export default {
  ...
  projects: [
    ...
    },
    {
      ...
      description: "Developed a web pastebin application using Python, Django, Vue.js, PostgreSQL, and Kubernetes. Features include paste sharing with expiration, custom URLs, login with LDAP, personal access tokens, paste history, search functionality, and built-in tools like a base64 converter, text diff, JSON formatter, and random password generator.",
    },
    {
